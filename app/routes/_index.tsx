...
import { ClarityCertificateSolid, Fa6SolidMoon, Fa6SolidSun, FluentEmojiHighContrastBuildingConstruction, MaterialSymbolsFramePerson, MdiMessageTextLock, PhBuildingsBold, StreamlineNatureEcologyLeafProtectEnvironmentLeafEcologyPlantPlantsEco } from "~/components/icons/icons";
        ...
        <div className="gap-4 mt-6 flex-col lg:flex-row relative items-center justify-around flex flex-wrap">
          ...
          {/* <div className="w-60 h-[24rem] rounded-lg relative overflow-hidden group">
            ...
            <div className="absolute bottom-0 left-0 w-full bg-black bg-opacity-70 p-4 rounded-b-xl h-32 translate-y-32 group-hover:translate-y-0 transition-all">
              <h1 className="text-gray-300 text-left text-xl font-semibold font-sans">Old Documents Service</h1>
              <p className="text-gray-300 text-left text-sm font-semibold font-sans">Obtain Old OC, CP and Maps efficiently.  </p>
            </div>
          </div> */}
          <div className="w-60 h-[24rem] rounded-xl relative overflow-hidden group">
