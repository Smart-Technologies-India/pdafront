                        ...
                        <>
                            <div className="flex flex-wrap gap-6 mt-4">
                                ...
                                {(common.form_status == 100 || common.form_status == 125) && user.id == 5 ?
                                    <Link to={`/petroleumpdf/${from_data.id}`} className="py-1 w-full sm:w-auto text-white text-lg px-4 bg-cyan-500 text-center rounded-md font-medium">View PDF</Link> : null
                                }
                            </div>
                        </>
                }
