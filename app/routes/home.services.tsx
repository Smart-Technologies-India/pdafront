    ...
    <>
      <div className="p-4 bg-white w-96 shadow-lg hover:shadow-2xl grid place-items-center h-80 rounded-xl">
        <div className="grid place-items-center gap-2 p-6">
          {props.icons == 1 ? (
            <MdiFolderInformation className="text-5xl text-[#0984e3]"></MdiFolderInformation>
          ) : null}
          {props.icons == 2 ? (
            <MdiMapMarkerPath className="text-5xl text-[#0984e3]"></MdiMapMarkerPath>
          ) : null}
          {props.icons == 3 ? (
            <FluentCloudArchive24Filled className="text-5xl text-[#0984e3]"></FluentCloudArchive24Filled>
          ) : null}
          {props.icons == 4 ? (
