        ...
        <>
            <div className="bg-white rounded-md shadow-lg p-4 my-4 w-full">
                <div className="relative grid place-content-center">
                    ...
                    {user.id == 7 ?
                        <Link to={"/home/petroleum"} className="my-2 lg:my-auto lg:absolute right-0 top-0 py-2 inline-block w-full sm:w-auto text-white text-lg px-4 bg-green-500 text-center rounded-md font-medium">Create Petroleum Form</Link>
                        : null
                    }
                </div>
