...
export const loader: LoaderFunction = async (props: LoaderArgs) => {
  ...
  const subdivision = await ApiCall({
    ...
    veriables: {
      searchSurveyInput: {
        villageId: parseInt(data.data.getOcById.village_id),
        survey_no: data.data.getOcById.survey_no,
      },
    },
  });
  ...
  //     veriables: {
  //       searchPaymentInput: {
  //         form_id: parseInt(data.data.getOcById.id),
  //         form_type: "OC",
  //       },
  //     },
  //   });
...
const OCView: React.FC = (): JSX.Element => {
...
//   });
  ...
  //             query: `
  //                         mutation updateOcById($updateOcInput:UpdateOcInput!){
  //                             updateOcById(updateOcInput:$updateOcInput){
  //                               id,
  //                             }
  //                           }
  //                         `,
  //             veriables: {
  //               updateOcInput: payreq,
  //             },
  //           });
    ...
    <>
      ...
      <div className="bg-white rounded-md shadow-lg p-4 my-4 w-full">
        ...
        <p className="text-center font-semibold text-xl text-gray-800">
          {" "}
          SUBJECT : Application for obtaining of Occupancy Certificate.
        </p>
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          ...
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal">
            {new Date(from_data.permission_date).toDateString()}
          </div>
        </div>
        {/*--------------------- section 2 end here ------------------------- */}
        ...
        <div className="flex  flex-wrap gap-4 gap-y-2 px-4 py-2 my-2">
          ...
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal">
            {new Date(from_data.completion_date).toDateString()}
          </div>
        </div>
        {/*--------------------- section 3 end here ------------------------- */}
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.2</span> Application form of Completion
            Certificate for Issue of Occupancy/Part Occupancy Certificate as per
            Annexure-13
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.3</span> True copy of Construction
            permission order
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.5</span> Annexure -14. (Applicable for High
            Rise Building Only).
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.6</span> Final NOC from Coast Guard
            Authority for building height.
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
              target="_blank"
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.7</span> Final NOC from Department of Fire
            & Emergency Services. (Applicable to all building except residential
            building with height less than 15.0 mts.)
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
              target="_blank"
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.8</span> Photo copy of installed Rain water
            harvesting system.
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.9</span> Existing building plan as per the
            actual construction carried out, if there is minor deviation from
            the approval plan.(If applicable)
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
              target="_blank"
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.10</span> Form of Indemnity -Annexure 16 on
            Stamp paper of Rs. 20/- (If application is for Part Occupancy)
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
              target="_blank"
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.11</span> Valuation Certificate for the
            building constructed from the Registered Architect/engineer.
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
              target="_blank"
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.12</span> Labour cess (@1% of Valuation of
            the building) Receipt
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
              target="_blank"
