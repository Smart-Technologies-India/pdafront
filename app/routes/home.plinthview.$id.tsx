...
export const loader: LoaderFunction = async (props: LoaderArgs) => {
  ...
  const village = await ApiCall({
    query: `
      ...
      `,
    veriables: {
      id: parseInt(data.data.getPlinthById.village_id),
    },
  });
  ...
  const subdivision = await ApiCall({
    ...
    veriables: {
      searchSurveyInput: {
        villageId: parseInt(data.data.getPlinthById.village_id),
        survey_no: data.data.getPlinthById.survey_no,
      },
    },
  });
  ...
  //     veriables: {
  //       searchPaymentInput: {
  //         form_id: parseInt(data.data.getPlinthById.id),
  //         form_type: "PLINTH",
  //       },
  //     },
  //   });
  ...
  return json({
    user: cookie,
    from_data: data.data.getPlinthById,
...
const PlinthView: React.FC = (): JSX.Element => {
  ...
  //             query: `
  //                         mutation updatePlinthById($updatePlinthInput:UpdatePlinthInput!){
  //                             updatePlinthById(updatePlinthInput:$updatePlinthInput){
  //                               id,
  //                             }
  //                           }
  //                         `,
  //             veriables: {
  //               updatePlinthInput: payreq,
  //             },
  //           });
    ...
    <>
      ...
      <div className="bg-white rounded-md shadow-lg p-4 my-4 w-full">
        ...
        <p className="text-center font-semibold text-xl text-gray-800">
          {" "}
          SUBJECT : Application for Issuance Of Plinth Inspection
        </p>
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          ...
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
              target="_blank"
              href={from_data.annexure_eleven}
              className="py-1 w-full sm:w-auto text-white text-lg px-4 bg-green-500 text-center rounded-md font-medium"
            >
              <div className="flex items-center gap-2">
                <Fa6SolidLink></Fa6SolidLink> View Doc.
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.3</span> Upload Certified Copy of
            Construction License
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
              target="_blank"
              href={from_data.copy_construcation_license}
              className="py-1 w-full sm:w-auto text-white text-lg px-4 bg-green-500 text-center rounded-md font-medium"
            >
              <div className="flex items-center gap-2">
                <Fa6SolidLink></Fa6SolidLink> View Doc.
        ...
        <div className="flex flex-wrap gap-4 gap-y-2 items-center px-4 py-2 my-2">
          <div className="flex-none lg:flex-1 w-full lg:w-auto text-xl font-normal text-left text-gray-700">
            <span className="mr-2">4.5</span> Approved Building Plan
          </div>
          <div className="flex-none flex gap-4 lg:flex-1 w-full lg:w-auto">
            <a
              target="_blank"
              href={from_data.architect_signature}
              className="py-1 w-full sm:w-auto text-white text-lg px-4 bg-green-500 text-center rounded-md font-medium"
            >
              <div className="flex items-center gap-2">
                <Fa6SolidLink></Fa6SolidLink> View Doc.
